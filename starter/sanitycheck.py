...
def run_sanity_check(test_dir):
    ...
    test_function_names = list(filter(
        lambda x: inspect.isfunction(getattr(module, x)) and not
    ...
    if not test_functions_for_get:
        ...
        print(
            ...
            method. This MUST test both the status code as well as the \
    ...
    if not test_functions_for_post:
        ...
        print(
            FAIL_COLOR + "Please make sure you have TWO test cases for the \
